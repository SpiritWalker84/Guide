...
```text
Код и структура — по гайду https://github.com/SpiritWalker84/Guide (docs/conventions/). Сперва анализ ТЗ, риски; спорные места — вопросы с вариантами A)/B) и плюсами/минусами (см. tz-analysis-workflow.md). Задача: …
```
